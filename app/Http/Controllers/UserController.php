...
class UserController extends Controller
{
    ...
    public function LoginUser(Request $request){
        ...
        $user = User::where("phone_number",$phone_number)->where("user_type",UserTypes::$CLIENT)->first();
    ...
    public function LoginDriver(Request $request){
        ...
        $user = User::where("phone_number",$phone_number)->where("user_type",UserTypes::$RIDER)->first();
        ...
        if($user!=null){
            if(Rider::where("device_token",$device_token)->exists()){
                ...
                if(LoginStatus::create($loginInfo)){

                    $riderInfo = Rider::where("user_id",$user->id)->first();
                    return response()->json([
                        "success" => true,
                        "response_code" => UserAuthenticationCodes::$LOGGED_IN_SUCCESSFULLY,
                        "message" => "Logged in successfully",
    ...
    public function updateUserDeviceToken(Request $request){
        ...
        $user = User::where("phone_number",$request->phone_number)->where("user_type",UserTypes::$CLIENT)->first();
    ...
    public function updateDriverDeviceToken(Request $request){
        ...
        $user = User::where("phone_number",$request->phone_number)->where("user_type",UserTypes::$RIDER)->first();
